...
def UQ_PowerSource(user_inputs,inputs,direct,**Scenarios):
    UQ_power_source=[]
...
def UQ_Converter(user_inputs,inputs,direct,**Scenarios):
    UQ_converter=[]
    for i in range(len(Scenarios.get('VAL_T'))):
...
def Losses_Converter(user_inputs,inputs,direct,**Scenarios):
    Losses_converter=[]
    for i in range(len(Scenarios.get('VAL_T'))):
