...
def UQ_Photodetector(Lidar,Atmospheric_Scenario,cts,Qlunc_yaml_inputs):
    ...
    * Qlunc_yaml_inputs
    ...
    # Plotting:
    QPlot.plotting(Lidar,Qlunc_yaml_inputs,Final_Output_UQ_Photo,False,Qlunc_yaml_inputs['Flags']['Photodetector noise'],False)
...
def UQ_Optical_amplifier(Lidar,Atmospheric_Scenario,cts,Qlunc_yaml_inputs): 
    ...
    * Qlunc_yaml_inputs
    ...
    OSNR_plot = 10*np.log10(((Lidar.photonics.photodetector.Power_interval)/(NF_w*cts.h*(cts.c/Lidar.lidar_inputs.Wavelength)*Lidar.photonics.optical_amplifier.OA_BW))/1000)
    ...
    # Plotting:
    # QPlot.plotting(Lidar,Qlunc_yaml_inputs,Final_Output_UQ_Optical_Amplifier,False,Qlunc_yaml_inputs['Flags']['Photodetector noise'])
...
def sum_unc_photonics(Lidar,Atmospheric_Scenario,cts,Qlunc_yaml_inputs): 
    ...
    if Lidar.photonics.photodetector != 'None':
        ...
        print('You didnt include a photodetector in the lidar.')
    ...
    if Lidar.photonics.optical_amplifier !='None':
        ...
        print('You didnt include an optical amplifier in the lidar.')
    ...
    if Lidar.photonics.laser !='None':
        ...
        print('You didn´t include a laser in the lidar.')
