...
class inputs():
    ...
    modules = {
               'power'     : {'power_source' :['power_source_noise'],                    # for now: power_source_noise,...
                              'converter'    :['converter_noise','converter_losses']},                      # for now:converter_noise,...
    
               'photonics' : {'photodetector':['photodetector_noise'],                   # for now:photodetector_noise,....
                              'amplifier'    :['amplifier_fignoise','amplifier_noise'],  #for now: amplifier_fignoise and amplifier_noise,...
