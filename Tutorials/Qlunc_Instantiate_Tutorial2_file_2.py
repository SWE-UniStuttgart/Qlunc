...
AOM = acousto_optic_modulator (name           = Qlunc_yaml_inputs2['Components']['AOM']['Name'],
                               ...
                               tau                        = Qlunc_yaml_inputs2['Components']['AOM']['Pulse shape'],
                               tau_meas                   = Qlunc_yaml_inputs2['Components']['AOM']['Gate length'], 
                               stdv_tau                   = Qlunc_yaml_inputs2['Components']['AOM']['stdv Pulse shape'],
                               stdv_tau_meas              = Qlunc_yaml_inputs2['Components']['AOM']['stdv Gate length'], 
